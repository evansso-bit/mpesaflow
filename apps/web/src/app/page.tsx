    ...
    <div className="min-h-screen bg-white text-gray-900 font-inter">
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-6 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-green-600 font-satoshi">
            MpesaFlow
          </h1>
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="/login" className="text-gray-600 hover:text-green-600">
              Login
            </a>
            <Link
              href="/"
      ...
      <main className="max-w-7xl mx-auto px-4 py-16">
        <AnimatedSection>
          <section className="text-center mb-16">
            ...
            >
              Streamline payments, gain insights, and scale your business with
              MpesaFlow's powerful SDK and comprehensive dashboard.
            </motion.p>
            <motion.a
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <AnimatedSection>
          <section id="docs" className="mb-16">
            <h3 className="text-2xl font-bold mb-4 font-satoshi text-center">
              Integrate MpesaFlow SDK in Minutes
            </h3>
        ...
        <AnimatedSection>
          <section id="features" className="mb-16">
            <h2 className="text-3xl font-bold mb-8 text-center font-satoshi">
              Why Choose MpesaFlow?
            </h2>
              ...
              {[
                {
                  ...
                  icon: Code,
                  description:
                    "Integrate M-Pesa payments with just a few lines of code.",
                },
                {
                  title: "Real-time Analytics",
                  icon: BarChart2,
                  description:
                    "Get instant insights on your payment transactions.",
                },
                {
                  title: "Secure & Reliable",
                  icon: Shield,
                  description:
                    "Bank-grade security for all your payment processes.",
                },
                {
                  title: "Scalable Solution",
                  icon: Zap,
                  description:
                    "Grow your business without worrying about payment infrastructure.",
                },
                {
                  title: "Customer Support",
                  icon: Headphones,
                  description: "24/7 support to help you with any issues.",
                },
                {
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold mb-2 font-satoshi">
                    {feature.title}
                  </h3>
          ...
          <section id="pricing" className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                >
                  <h3 className="text-2xl font-bold mb-2 font-satoshi">
                    {plan.name}
                  </h3>
        ...
        <AnimatedSection>
          <section id="contact" className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Contact our team today and learn how MpesaFlow can transform your
              business.
            </p>
            <a
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Simplifying M-Pesa integration for businesses of all sizes.
              </p>
            </div>
            <div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center">
            <p className="text-sm text-gray-400">
              &copy; 2023 MpesaFlow. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
