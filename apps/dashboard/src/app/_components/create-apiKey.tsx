...
export default function CreateApiKey({ applicationId, enviroment }: { applicationId: string, enviroment: string }) {
            ...
            <DialogContent className="sm:max-w-[425px]">
                ...
                <form action={formAction}>
                    <div>
                        ...
                        <Input type="text" placeholder="Enter API name" name="name" required />
